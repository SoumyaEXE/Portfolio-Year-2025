...
export const metadata: Metadata = {
  ...
  title: "Soumyadeep Dey | Full-Stack Software Developer",
  description:
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: DOMAIN,
    title: "Soumyadeep Dey | Full-Stack Software Developer & Interface Architect",
    description:
      "Discover the portfolio of Soumyadeep Dey, a software developer specializing in crafting beautiful web applications with React, Next.js & TypeScript. View projects demonstrating clean code, accessibility & stunning UIs.",
    siteName: "Soumyadeep Dey | Developer Portfolio",
    images: [
      {
        url: `${DOMAIN}/og.png`,
        width: 1200,
        height: 630,
        alt: "Soumyadeep Dey - Software Developer Portfolio featuring React and Next.js projects",
      },
    ],
  },
  twitter: {
  ...
  verification: {
    ...
    other: {
      me: ["mailto:soumyadeep@example.com", "https://github.com/SoumyaEXE"],
    },
  },
  alternates: {
    canonical: DOMAIN,
